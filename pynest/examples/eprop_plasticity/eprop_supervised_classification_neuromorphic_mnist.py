...
at that time. Each readout neuron compares the network signal :math:`y_k` with the target signal :math:`y_k^*`,
...
cfg = dict(
    ...
    tau_m_out=50.0,
    verify=True,
    weight_dale_enforced_inp=True,
    weight_dale_enforced_out=True,
    weight_dale_enforced_rec=True,
