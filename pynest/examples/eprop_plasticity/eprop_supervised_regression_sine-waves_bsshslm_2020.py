...
.. image:: ../../../../pynest/examples/eprop_plasticity/eprop_supervised_regression_schematic_sine-waves_bsshslm_2020.png
   :width: 70 %
...
batch_size = args.batch_size  # batch size, 1 in reference [2]
